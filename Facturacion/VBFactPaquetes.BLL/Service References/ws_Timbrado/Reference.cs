...
namespace VBFactPaquetes.BLL.ws_Timbrado {
    ...
    public interface FacturaloTimbradoWSPortType {
        ...
        VBFactPaquetes.BLL.ws_Timbrado.RespuestaTimbrado timbrar(string apikey, string request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:FacturaloTimbradoWS#timbrarTXT", ReplyAction="*")]
        [return: System.ServiceModel.MessageParameterAttribute(Name="return")]
        System.Threading.Tasks.Task<VBFactPaquetes.BLL.ws_Timbrado.RespuestaTimbrado> timbrarAsync(string apikey, string request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface FacturaloTimbradoWSPortTypeChannel : VBFactPaquetes.BLL.ws_Timbrado.FacturaloTimbradoWSPortType, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FacturaloTimbradoWSPortTypeClient : System.ServiceModel.ClientBase<VBFactPaquetes.BLL.ws_Timbrado.FacturaloTimbradoWSPortType>, VBFactPaquetes.BLL.ws_Timbrado.FacturaloTimbradoWSPortType {
        ...
        public VBFactPaquetes.BLL.ws_Timbrado.RespuestaTimbrado timbrar(string apikey, string request) {
            return base.Channel.timbrar(apikey, request);
        }
        
        public System.Threading.Tasks.Task<VBFactPaquetes.BLL.ws_Timbrado.RespuestaTimbrado> timbrarAsync(string apikey, string request) {
