...
{
	public class DALNotascreditoCab: ENTNotascreditoCab
	{
		...
		protected DALNotascreditoCab _copia;
		#endregion Propiedades Privadas

		#region Constructores
		public DALNotascreditoCab(SqlConnection conexion)
		{
			_conexion = conexion;
			IniciarPropiedades();
		}
		...
		#region Agregar VBFac_NotasCredito_Cab
		public void Agregar()
		{
			_nuevo = true;
			...
			SqlParameter param7 = new SqlParameter("@FolioFiscal", SqlDbType.BigInt);
			param7.Value = FolioFiscal;
			...
			SqlParameter param12 = new SqlParameter("@RfcReceptor", SqlDbType.VarChar);
			param12.Value = RfcReceptor;
			commandParameters.Add(param12);
			SqlParameter param13 = new SqlParameter("@EmailReceptor", SqlDbType.VarChar);
			param13.Value = EmailReceptor;
			commandParameters.Add(param13);
			SqlParameter param14 = new SqlParameter("@EsExtranjero", SqlDbType.Bit);
			param14.Value = EsExtranjero;
			commandParameters.Add(param14);
			SqlParameter param15 = new SqlParameter("@IdPaisResidenciaFiscal", SqlDbType.VarChar);
			param15.Value = IdPaisResidenciaFiscal;
			commandParameters.Add(param15);
			SqlParameter param16 = new SqlParameter("@NumRegIdTrib", SqlDbType.VarChar);
			param16.Value = NumRegIdTrib;
			commandParameters.Add(param16);
			SqlParameter param17 = new SqlParameter("@UsoCFDI", SqlDbType.VarChar);
			param17.Value = UsoCFDI;
			commandParameters.Add(param17);
			SqlParameter param18 = new SqlParameter("@FormaPago", SqlDbType.VarChar);
			param18.Value = FormaPago;
			commandParameters.Add(param18);
			SqlParameter param19 = new SqlParameter("@MetodoPago", SqlDbType.VarChar);
			param19.Value = MetodoPago;
			commandParameters.Add(param19);
			SqlParameter param20 = new SqlParameter("@TipoComprobante", SqlDbType.VarChar);
			param20.Value = TipoComprobante;
			commandParameters.Add(param20);
			SqlParameter param21 = new SqlParameter("@LugarExpedicion", SqlDbType.VarChar);
			param21.Value = LugarExpedicion;
			commandParameters.Add(param21);
			SqlParameter param22 = new SqlParameter("@CondicionesPago", SqlDbType.VarChar);
			param22.Value = CondicionesPago;
			commandParameters.Add(param22);
			SqlParameter param23 = new SqlParameter("@Moneda", SqlDbType.VarChar);
			param23.Value = Moneda;
			commandParameters.Add(param23);
			SqlParameter param24 = new SqlParameter("@TipoCambio", SqlDbType.Money);
			param24.Value = TipoCambio;
			commandParameters.Add(param24);
			SqlParameter param25 = new SqlParameter("@SubTotal", SqlDbType.Money);
			param25.Value = SubTotal;
			commandParameters.Add(param25);
			SqlParameter param26 = new SqlParameter("@Descuento", SqlDbType.Money);
			param26.Value = Descuento;
			commandParameters.Add(param26);
			SqlParameter param27 = new SqlParameter("@Total", SqlDbType.Money);
			param27.Value = Total;
			...
			SqlParameter param33 = new SqlParameter("@IdAgente", SqlDbType.Int);
			param33.Value = IdAgente;
			commandParameters.Add(param33);
			SqlParameter param34 = new SqlParameter("@IdUsuario", SqlDbType.Int);
			param34.Value = IdUsuario;
			commandParameters.Add(param34);
			SqlParameter param35 = new SqlParameter("@IdUsuarioCancelo", SqlDbType.Int);
			param35.Value = IdUsuarioCancelo;
			commandParameters.Add(param35);
			SqlParameter param36 = new SqlParameter("@FechaHoraCancelLocal", SqlDbType.VarChar);
			param36.Value = FechaHoraCancelLocal.Year > 1900 ? FechaHoraCancelLocal.ToString("yyyy-MM-dd HH:mm:ss.fff") : ""; 
			commandParameters.Add(param36);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_InsNotasCreditoCab";
			...
			try
			{
				...
				if (dsResult.Tables["dtResultado"].Rows.Count >= 1)
				{
					...
					{
						IdNotaCreditoCab = Convert.ToInt64(cmm.Parameters[0].Value);
		...
		#region Actualizar VBFac_NotasCredito_Cab
		public void Actualizar()
		{
			...
			commandParameters.Add(param36);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_UpdNotasCreditoCab";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Eliminar VBFac_NotasCredito_Cab
		public void Eliminar(long idnotacreditocab)
		{
			...
			commandParameters.Add(param0);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_DelNotasCreditoCab";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Deshacer VBFac_NotasCredito_Cab
		...
		public List<ENTNotascreditoCab> RecuperarTodo()
		{
			List<ENTNotascreditoCab> result = new List<ENTNotascreditoCab>();
			DataTable dtResultado = new DataTable();
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetNotasCreditoCab_TODO";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			...
			try
			{
				...
				{
				    ENTNotascreditoCab item = new ENTNotascreditoCab();
					 ...
					 if (!dr.IsNull("FolioFiscal")) item.FolioFiscal = Convert.ToInt64(dr["FolioFiscal"]);
		...
		#region Recuperar RecuperarNotascreditoCabPorLlavePrimaria
		public List<ENTNotascreditoCab> RecuperarNotascreditoCabPorLlavePrimaria(long idnotacreditocab)
		{
			List<ENTNotascreditoCab> result = new List<ENTNotascreditoCab>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetNotasCreditoCab_POR_PK";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
			...
			try
			{
				...
				if (dtResultado.Rows.Count.Equals(1))
				{
					...
					if (!dtResultado.Rows[0].IsNull("FolioFiscal")) FolioFiscal = Convert.ToInt64(dtResultado.Rows[0]["FolioFiscal"]);
		...
		#region Recuperar RecuperarNotascreditoCabIdpeticionpac
		public List<ENTNotascreditoCab> RecuperarNotascreditoCabIdpeticionpac(long idpeticionpac)
		{
			List<ENTNotascreditoCab> result = new List<ENTNotascreditoCab>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetNotasCreditoCab_POR_IdPeticionPAC";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		public object Clone()
		{
			_copia = new DALNotascreditoCab(_conexion);
			Type tipo = typeof(ENTNotascreditoCab);
