...
{
	public class DALProrrogafactReg: ENTProrrogafactReg
	{
		...
		protected DALProrrogafactReg _copia;
		#endregion Propiedades Privadas

		#region Constructores
		public DALProrrogafactReg(SqlConnection conexion)
		{
			_conexion = conexion;
			IniciarPropiedades();
		}
		...
		#region Agregar VBFac_ProrrogaFact_Reg
		public void Agregar()
		{
			_nuevo = true;
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			SqlCommand cmm = new SqlCommand();
			SqlParameter param0 = new SqlParameter("@IdProrroga", SqlDbType.Int);
			param0.Value = IdProrroga;
			...
			SqlParameter param3 = new SqlParameter("@NumDiasFacturacion", SqlDbType.Int);
			param3.Value = NumDiasFacturacion;
			commandParameters.Add(param3);
			SqlParameter param4 = new SqlParameter("@Activo", SqlDbType.Bit);
			param4.Value = Activo;
			commandParameters.Add(param4);
			SqlParameter param5 = new SqlParameter("@IdUsuario", SqlDbType.Int);
			param5.Value = IdUsuario;
			commandParameters.Add(param5);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_InsProrrogaFactReg";
			...
			try
			{
				...
				if (dsResult.Tables["dtResultado"].Rows.Count >= 1)
				{
					...
					{
						IdProrroga = Convert.ToInt32(cmm.Parameters[0].Value);
		...
		#region Actualizar VBFac_ProrrogaFact_Reg
		public void Actualizar()
		{
			...
			commandParameters.Add(param5);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_UpdProrrogaFactReg";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Eliminar VBFac_ProrrogaFact_Reg
		public void Eliminar(int idprorroga)
		{
			_nuevo = false;
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			SqlCommand cmm = new SqlCommand();
			...
			commandParameters.Add(param0);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_DelProrrogaFactReg";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Deshacer VBFac_ProrrogaFact_Reg
		public void Deshacer()
		{
			if (_nuevo)
			{
				this.Eliminar(IdProrroga);
			}
			else
			{
				if(_copia != null)
		...
		public List<ENTProrrogafactReg> RecuperarTodo()
		{
			List<ENTProrrogafactReg> result = new List<ENTProrrogafactReg>();
			DataTable dtResultado = new DataTable();
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetProrrogaFactReg_TODO";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			...
			try
			{
				...
				{
				    ENTProrrogafactReg item = new ENTProrrogafactReg();
					 if (!dr.IsNull("IdProrroga")) item.IdProrroga = Convert.ToInt32(dr["IdProrroga"]);
					 ...
					 if (!dr.IsNull("NumDiasFacturacion")) item.NumDiasFacturacion = Convert.ToInt32(dr["NumDiasFacturacion"]);
		...
		#region Recuperar RecuperarProrrogafactRegPorLlavePrimaria
		public List<ENTProrrogafactReg> RecuperarProrrogafactRegPorLlavePrimaria(int idprorroga)
		{
			List<ENTProrrogafactReg> result = new List<ENTProrrogafactReg>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetProrrogaFactReg_POR_PK";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
			...
			try
			{
				...
				{
					if (!dtResultado.Rows[0].IsNull("IdProrroga")) IdProrroga = Convert.ToInt32(dtResultado.Rows[0]["IdProrroga"]);
					...
					if (!dtResultado.Rows[0].IsNull("NumDiasFacturacion")) NumDiasFacturacion = Convert.ToInt32(dtResultado.Rows[0]["NumDiasFacturacion"]);
		...
		#region Recuperar RecuperarProrrogafactRegBookingid
		public List<ENTProrrogafactReg> RecuperarProrrogafactRegBookingid(long bookingid)
		{
			List<ENTProrrogafactReg> result = new List<ENTProrrogafactReg>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetProrrogaFactReg_POR_BookingID";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Recuperar RecuperarProrrogafactRegRecordlocator
		public List<ENTProrrogafactReg> RecuperarProrrogafactRegRecordlocator(string recordlocator)
		{
			List<ENTProrrogafactReg> result = new List<ENTProrrogafactReg>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetProrrogaFactReg_POR_RecordLocator";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		public object Clone()
		{
			_copia = new DALProrrogafactReg(_conexion);
			Type tipo = typeof(ENTProrrogafactReg);
