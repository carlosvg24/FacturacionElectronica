...
{
	public class DALFacturascfdiDet: ENTFacturascfdiDet
	{
		...
		protected DALFacturascfdiDet _copia;
		#endregion Propiedades Privadas

		#region Constructores
		public DALFacturascfdiDet(SqlConnection conexion)
		{
			_conexion = conexion;
			IniciarPropiedades();
		}
		...
		#region Agregar VBFac_FacturasCFDI_Det
		public void Agregar()
		{
			_nuevo = true;
			...
			cmm.CommandText = "uspFac_InsFacturasCFDIDet";
		...
		#region Actualizar VBFac_FacturasCFDI_Det
		public void Actualizar()
		{
			...
			commandParameters.Add(param4);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_UpdFacturasCFDIDet";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Eliminar VBFac_FacturasCFDI_Det
		public void Eliminar(long idfacturacab)
		{
			...
			commandParameters.Add(param0);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_DelFacturasCFDIDet";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Deshacer VBFac_FacturasCFDI_Det
		...
		public List<ENTFacturascfdiDet> RecuperarTodo()
		{
			List<ENTFacturascfdiDet> result = new List<ENTFacturascfdiDet>();
			DataTable dtResultado = new DataTable();
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetFacturasCFDIDet_TODO";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			...
			try
			{
				...
				{
				    ENTFacturascfdiDet item = new ENTFacturascfdiDet();
		...
		#region Recuperar RecuperarFacturascfdiDetPorLlavePrimaria
		public List<ENTFacturascfdiDet> RecuperarFacturascfdiDetPorLlavePrimaria(long idfacturacab)
		{
			List<ENTFacturascfdiDet> result = new List<ENTFacturascfdiDet>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetFacturasCFDIDet_POR_PK";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Recuperar RecuperarFacturascfdiDetIdfacturacab
		public List<ENTFacturascfdiDet> RecuperarFacturascfdiDetIdfacturacab(long idfacturacab)
		{
			List<ENTFacturascfdiDet> result = new List<ENTFacturascfdiDet>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetFacturasCFDIDet_POR_IdFacturaCab";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		public object Clone()
		{
			_copia = new DALFacturascfdiDet(_conexion);
			Type tipo = typeof(ENTFacturascfdiDet);
