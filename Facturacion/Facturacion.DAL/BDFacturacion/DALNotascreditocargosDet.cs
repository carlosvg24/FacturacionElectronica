...
{
	public class DALNotascreditocargosDet: ENTNotascreditocargosDet
	{
		...
		protected DALNotascreditocargosDet _copia;
		#endregion Propiedades Privadas

		#region Constructores
		public DALNotascreditocargosDet(SqlConnection conexion)
		{
			_conexion = conexion;
			IniciarPropiedades();
		}
		...
		#region Agregar VBFac_NotasCreditoCargos_Det
		public void Agregar()
		{
			_nuevo = true;
			...
			cmm.CommandText = "uspFac_InsNotasCreditoCargosDet";
		...
		#region Actualizar VBFac_NotasCreditoCargos_Det
		public void Actualizar()
		{
			...
			commandParameters.Add(param3);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_UpdNotasCreditoCargosDet";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Eliminar VBFac_NotasCreditoCargos_Det
		public void Eliminar(long idnotacreditocab,int idnotacreditodet)
		{
			...
			commandParameters.Add(param1);
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_DelNotasCreditoCargosDet";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Deshacer VBFac_NotasCreditoCargos_Det
		...
		public List<ENTNotascreditocargosDet> RecuperarTodo()
		{
			List<ENTNotascreditocargosDet> result = new List<ENTNotascreditocargosDet>();
			DataTable dtResultado = new DataTable();
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetNotasCreditoCargosDet_TODO";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			...
			try
			{
				...
				{
				    ENTNotascreditocargosDet item = new ENTNotascreditocargosDet();
		...
		#region Recuperar RecuperarNotascreditocargosDetPorLlavePrimaria
		public List<ENTNotascreditocargosDet> RecuperarNotascreditocargosDetPorLlavePrimaria(long idnotacreditocab,int idnotacreditodet)
		{
			List<ENTNotascreditocargosDet> result = new List<ENTNotascreditocargosDet>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetNotasCreditoCargosDet_POR_PK";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		#region Recuperar RecuperarNotascreditocargosDetIdnotacreditocabIdnotacreditodet
		public List<ENTNotascreditocargosDet> RecuperarNotascreditocargosDetIdnotacreditocabIdnotacreditodet(long idnotacreditocab,int idnotacreditodet)
		{
			List<ENTNotascreditocargosDet> result = new List<ENTNotascreditocargosDet>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
			...
			SqlCommand cmm = new SqlCommand();
			cmm.CommandType = CommandType.StoredProcedure;
			cmm.CommandText = "uspFac_GetNotasCreditoCargosDet_POR_IdNotaCreditoCab_IdNotaCreditoDet";
			cmm.CommandTimeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SqlCommandTimeOut"]); 
			cmm.Connection = _conexion;
			bool cerrarConexion = false;
			foreach(SqlParameter p in commandParameters)
		...
		public object Clone()
		{
			_copia = new DALNotascreditocargosDet(_conexion);
			Type tipo = typeof(ENTNotascreditocargosDet);
