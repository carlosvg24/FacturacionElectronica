...
{
	public class DALXmlPegaso: ENTXmlPegaso
	{
		...
		protected DALXmlPegaso _copia;
		#endregion Propiedades Privadas

		#region Constructores
		public DALXmlPegaso(SqlConnection conexion)
		{
			_conexion = conexion;
			IniciarPropiedades();
		}
		...
		public List<ENTXmlPegaso> RecuperarTodo()
		{
			List<ENTXmlPegaso> result = new List<ENTXmlPegaso>();
			...
			try
			{
				...
				{
				    ENTXmlPegaso item = new ENTXmlPegaso();
		...
		public List<ENTXmlPegaso> RecuperarXmlPegasoPorLlavePrimaria(long idpeticionpac)
		{
			List<ENTXmlPegaso> result = new List<ENTXmlPegaso>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
		...
		public List<ENTXmlPegaso> RecuperarXmlPegasoFoliocfdi(long foliocfdi)
		{
			List<ENTXmlPegaso> result = new List<ENTXmlPegaso>();
			DataTable dtResultado = new DataTable();
			List<SqlParameter> commandParameters = new List<SqlParameter>();
		...
		public object Clone()
		{
			_copia = new DALXmlPegaso(_conexion);
			Type tipo = typeof(ENTXmlPegaso);
