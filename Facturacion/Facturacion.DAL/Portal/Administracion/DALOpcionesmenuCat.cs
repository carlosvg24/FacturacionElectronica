...
namespace Facturacion.DAL.Portal
{
    public class DALOpcionesmenuCat : ENTOpcionesmenuCat
    {
        ...
        public List<ENTOpcionesmenuCat> RecuperarTodo(ENTOpcionesmenuCat menuCat)
        {
            List<ENTOpcionesmenuCat> result = new List<ENTOpcionesmenuCat>();
            DataTable dtResultado = new DataTable();
            SqlCommand cmm = new SqlCommand();
            cmm.CommandType = CommandType.StoredProcedure;
            cmm.CommandText = "uspFac_GetOpcionesMenuCat";
            cmm.Connection = _conexion;
            bool cerrarConexion = false;
            ...
            try
            {
                ...
                cmm.Parameters.AddWithValue("@IdMenuOpcion", menuCat.IdMenuOpcion);
                cmm.Parameters.AddWithValue("@IdMenuPadre", menuCat.IdMenuPadre);
                cmm.Parameters.AddWithValue("@Nombre", menuCat.Nombre);
                cmm.Parameters.AddWithValue("@Descripcion", menuCat.Descripcion);
                cmm.Parameters.AddWithValue("@UrlMenu", menuCat.UrlMenu);
                cmm.Parameters.AddWithValue("@UrlImagen", menuCat.UrlImagen);
                cmm.Parameters.AddWithValue("@Activo", menuCat.Activo);
        ...
        public List<ENTOpcionesmenuCat> RecuperarDDl()
        {
            List<ENTOpcionesmenuCat> result = new List<ENTOpcionesmenuCat>();
            DataTable dtResultado = new DataTable();
            SqlCommand cmm = new SqlCommand();
            ...
            try
            {
                ...
                cmm.Parameters.AddWithValue("@Activo", 1);
