...
namespace Comun.Utils
{
    public class FormatoNumLetra
    {
        ...
        public String Convertir(String numero, bool mayusculas,String tipoMoneda)
        {   
            ...
            if (mc.Count > 0)
            {
                ...
                //se da formato al numero decimal cuando es pesos
                if (tipoMoneda == "MXN")
                {                    
                    parte_decimal = "pesos con " + Num[1].Substring(0,2) + "/100 MXN";
                }
                //se da formato al numero decimal cuando es dolares
