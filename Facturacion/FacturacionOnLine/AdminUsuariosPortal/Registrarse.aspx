<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Master/OLD.Master" AutoEventWireup="true" CodeBehind="Registrarse.aspx.cs" Inherits="FacturacionOnLine.AdminUsuariosPortal.Registrarse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" EnableViewState="true" ViewStateMode="Enabled">
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnRegistrarse" />
        </Triggers>
        <ContentTemplate>
...
<%--    <asp:UpdateProgress ID="UpdateProgress" runat="server">
        <ProgressTemplate>
            ...
            <div class="dv_progress">
                <img alt="" src="<%= Page.ResolveUrl("~/Contents/Images/Loading.gif")%>" class="img_progress"/>
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>--%>
</asp:Content>